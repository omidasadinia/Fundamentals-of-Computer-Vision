clear all;
close all;
a = imread('LineWith2Points.png');
% a = imread('LineWith3Points.png');
% a = imread('LineSharp.png');
% a = imread('2LinesSharp.png');
...
figure(1)
subplot(1, 2, 1), imshow(a, []), impixelinfo;
subplot(1, 2, 2), imshow(H, []), impixelinfo;
